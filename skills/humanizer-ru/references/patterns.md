# Справочник паттернов AI-слопа (37 паттернов)
...
### 13. Негативные параллелизмы

**Проблема:** Конструкции «не только... но и...», «не просто... а...» часто выглядят как AI-попытка искусственно уравновесить мысль. Но сама конструкция не доказывает слоп и может быть точнее любого обходного варианта.

**Правило:** оценивай её в контексте. Переписывай только если контраст декоративный, раздувает значимость или мешает прямой мысли.
...
**Проблема:** Модель может маскировать пустоту разметкой: жирным, эмодзи или декоративными заголовками. Но humanizer-ru не меняет Markdown-разметку: она относится к оформлению и может быть значимой для автора.

**Правило:** в режиме правки не добавляй, не удаляй и не переставляй эмодзи, заголовки, жирные фрагменты, списки, таблицы, ссылки, отступы, схемы и блоки кода. В detect-режиме можно назвать форматирование признаком, но текст не менять.
...
### 23. Математические и кодовые знаки

**Проблема:** Нотация из кода и математики может утяжелить обычную прозу. В техническом объяснении, схеме или кратком сравнении она часто точнее слов.

**Правило:** оставляй знаки, когда они сохраняют точность или читаются естественно для аудитории. Переписывай только если нотация выглядит как декоративный слоп или реально мешает чтению.
...
**Проблема:** Одинаковый глагол в двух параллельных предложениях иногда делает текст механическим. Разные формы одной основы, повтор темы и намеренный ритм сами по себе не проблема.

**Правило:** отмечай только точный повтор одного глагола в соседних предложениях одного прозаического абзаца. Исправляй, когда параллелизм действительно режет слух; не гони текст к разнообразию ради разнообразия.

---

### 34. Стопка абзацев без связок

**Проблема:** Каждый прозаический абзац начинается с чистого листа, как новый пункт списка. Человек строит поток - каждый следующий абзац цепляется за предыдущий. Модель складывает стопку: «Кроме того...», «Также...», «Ещё один аспект...». Бан отдельных фраз-переходов (паттерн 11) это не лечит: убрав «кроме того», модель просто начнёт абзац с новой темы без всякой связи.

**Граница:** правило относится только к связанному прозаическому изложению. Оно не требует склеивать независимые разделы, элементы списка, строки таблицы, пункты плана и блоки с разными функциями.

**Правило:** каждый прозаический абзац после первого связан с предыдущим одним из четырёх ходов:
